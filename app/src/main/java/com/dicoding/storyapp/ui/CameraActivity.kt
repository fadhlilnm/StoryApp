...
import com.dicoding.storyapp.ui.util.createCustomTempFile
    ...
    private fun initializeCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            try {
                ...
                Toast.makeText(this@CameraActivity, "Failed to display camera.", Toast.LENGTH_SHORT).show()
                Log.e(TAG, "initializeCamera: ${exc.message}")
            }
